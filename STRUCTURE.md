...
| `marka.go` | **Stage 2 (S2-3)**: переприменение словаря cargo после carry-over, бизнес-атрибуция новых вагонов из marka (ключ по группе груза), расчёт sms_2, перестановки назначения. |
