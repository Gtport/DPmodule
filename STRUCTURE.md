...
| `sf.go` | Кандидаты для с.ф.-ниток: группы, стоящие на станции формирования синонима (справочник sf), + «уехавшие» сборные — по префиксу индекса (АААА = kod_4 станции формирования, хвост не проверяется); исключение занятых обычными нитками. |
