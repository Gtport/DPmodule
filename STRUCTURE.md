...
| `marka.go` | **Stage 2 (S2-3)**: переприменение словаря cargo после carry-over, бизнес-атрибуция новых вагонов из marka (ключ по группе груза), наследование по составу (S2-3d, единогласные соседи по IndexMain), расчёт sms_2, перестановки назначения. |
