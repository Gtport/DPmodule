...
| `sf.go` | Кандидаты для с.ф.-ниток: несобранные группы на станции формирования синонима (справочник sf) + сформированные сборные по префиксу индекса (АААА = kod_4 станции формирования; все парки станции, хвост не проверяется) — уехавшие и ещё стоящие; исключение занятых обычными нитками. |
