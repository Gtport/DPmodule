...
| `marka.go` | **Stage 2 (S2-3)**: переприменение словаря cargo после carry-over, бизнес-атрибуция новых вагонов из marka (СТРОГО по ключу окпо+станция+группа, без частичного матча), наследование по составу (S2-3d, единогласные соседи по IndexMain), расчёт sms_2, перестановки назначения. |
