...
-- ── 7. Раскладка колонок отчёта «Подход груза» (nmtp_*) — опционально ────────
--  Отчёт (экс-«Отчёты НМТП») есть у КАЖДОГО клиента по всем терминалам реестра
--  (решение владельца 13.08.2026): без раскладки весь груз падает в одну
--  колонку «прочее». nmtp_column сеют, когда клиенту нужны свои грузовые
--  колонки (клиент × станции × марка). Образец раскладки — gtport.sql
--  (guard WHERE NOT EXISTS по терминалу обязателен: у nmtp_column нет
--  уникального ключа).
