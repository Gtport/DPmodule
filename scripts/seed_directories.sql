...
\copy marka(okpo,station_kod,station,cargo_group,shipper,client,sms_1,sms_3) FROM '_reference/seed/marka.csv' WITH (FORMAT csv, HEADER true, FORCE_NOT_NULL (sms_3))
