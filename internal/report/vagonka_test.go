...
func vagTestRecord() domain.Dislocation {
	...
	return domain.Dislocation{
		...
		Zayavka: "0012345678", CargoS: "УГОЛЬ Д", CargoSms: "Д",
		FreightExactName: "УГОЛЬ КАМЕННЫЙ МАРКИ Д (0-100)", GtdNumber: "10702070/280726/0001234",
		Ves:         &ves,
...
func TestVagonkaXLSX_Values(t *testing.T) {
	...
	want := map[string]string{
		...
		"Марка груза":         "УГОЛЬ КАМЕННЫЙ МАРКИ Д (0-100)", // freight_exact_name (уточнение владельца)
		"ГТД":                 "10702070/280726/0001234",
		"Вес (тн)":            "69.5",
		"Вес (кг)":            "69500",
		"Операция с вагоном":  "Бросание поезда на промежуточной станции", // oper — полное имя
