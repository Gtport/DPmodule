...
// vagon_history.date_prib, а он для статуса 10 — момент прибытия ИЗ ПОТОКА, уже
// СДВИНУТЫЙ в ЖД-шкалу (+24ч при часе ≥ отсечки, history.go historyArrival;
// до 06.08.2026 сюда шёл date_kon = date_op_jd, шкала та же). Поэтому
